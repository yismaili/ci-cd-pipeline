                ...
                dir('frontend') {
                    script {
                        try {
                           ...
                           // sudo scp frontend-${GIT_COMMIT_SHORT}-${BUILD_NUMBER}.tar ${REMOTE_SERVER}:${REMOTE_PATH}
                            """
                        } catch (Exception e) {
                ...
                dir('backend') {
                    script {
                        try {
                           ...
                           // sudo scp backend-${GIT_COMMIT_SHORT}-${BUILD_NUMBER}.tar ${REMOTE_SERVER}:${REMOTE_PATH}
                            """
                        } catch (Exception e) {
